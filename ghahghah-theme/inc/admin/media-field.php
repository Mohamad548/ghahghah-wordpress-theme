...
function ghahghah_admin_render_media_field(
	...
	<div class="ghahghah-media-field" data-ghahghah-media-field>
		...
		<div class="ghahghah-media-field__row">
			...
			<div class="ghahghah-media-field__side">
				...
				<div class="ghahghah-media-field__actions">
					<button type="button" class="ghahghah-btn ghahghah-btn--solid" data-ghahghah-media-upload>
						<?php esc_html_e( 'انتخاب / بارگذاری', 'ghahghah' ); ?>
					</button>
					<button type="button" class="ghahghah-btn ghahghah-btn--ghost" data-ghahghah-media-reset <?php echo $attachment_id > 0 ? '' : 'hidden'; ?>>
