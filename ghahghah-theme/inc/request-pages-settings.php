...
/**
 * Wholesale page hero product image (optimized WebP packshot; PNG retained on disk).
 *
 * @return array{src: string, srcset: string, width: int, height: int}
 */
...
/**
 * Agency page hero product image (optimized WebP packshot; PNG retained on disk).
 *
 * @return array{src: string, srcset: string, width: int, height: int}
 */
